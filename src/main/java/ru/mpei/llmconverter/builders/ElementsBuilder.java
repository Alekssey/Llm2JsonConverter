...
//        "SUBSTATION", "noId", "NAME", "Двухобмоточный трансформатор", "FREQUENCY", "50", "RATED_APPARENT_POWER", "16", "FIRST_WINDING_RATED_VOLTAGE", "115", "SECOND_WINDING_RATED_VOLTAGE", "11", "SHORT_CIRCUIT_VOLTAGE", "10.5", "SHORT_CIRCUIT_ACTIVE_POWER", "85", "IDLING_ACTIVE_POWER", "19", "IDLING_CURRENT", "0.7",
//                "FIRST_WINDING_TYPE", "yg", "SECOND_WINDING_TYPE", "d11", "SATURATION_EXIST", "no", "MAGNETIZATION_VOLTAGE", "1.17", "AIR_CORE_RESISTANCE", "0.2", "SATURATION_COEFFICIENT", "1.25", "TAP_CHANGER_EXISTENCE", "disabled", "TAP_CHANGER_INSTALLATION_WINDING", "onFirstWinding",
//                "TAP_CHANGER_DEFAULT_POSITION", "0", "TAP_CHANGER_VOLTAGE_CHANGE", "1.78", "TAP_CHANGER_MAX_POSITION", "9", "TAP_CHANGER_MIN_POSITION", "-9"
    ...
    public Node buildThreeWindingTransformer(String highVoltageLevel, String midVoltageLevel, String lowVoltageLevel, double x, double y) {
        ...
        transformer.getFields().putAll(Map.of("TAP_CHANGER_EXISTENCE", "disabled", "TAP_CHANGER_INSTALLATION_WINDING", "onFirstWinding", "TAP_CHANGER_DEFAULT_POSITION", "0", "TAP_CHANGER_VOLTAGE_CHANGE", "1.78", "TAP_CHANGER_MAX_POSITION", "9", "TAP_CHANGER_MIN_POSITION", "-9"));

//        "SUBSTATION", "noId", "NAME", "Трехобмоточный трансформатор", "FREQUENCY", "50", "RATED_APPARENT_POWER", "16", "FIRST_WINDING_RATED_VOLTAGE", "115", "SECOND_WINDING_RATED_VOLTAGE", "34.5", "THIRD_WINDING_RATED_VOLTAGE", "11", "FIRST_SECOND_WINDING_SHORT_CIRCUIT_VOLTAGE", "10.5", "FIRST_THIRD_WINDING_SHORT_CIRCUIT_VOLTAGE", "17", "SECOND_THIRD_WINDING_SHORT_CIRCUIT_VOLTAGE", "6"
//        "SHORT_CIRCUIT_ACTIVE_POWER", "100", "IDLING_ACTIVE_POWER", "23", "IDLING_CURRENT", "1", "FIRST_WINDING_TYPE", "yg", "SECOND_WINDING_TYPE", "yg", "THIRD_WINDING_TYPE", "d11", "SATURATION_EXIST", "no", "MAGNETIZATION_VOLTAGE", "1.17", "AIR_CORE_RESISTANCE", "0.2", "SATURATION_COEFFICIENT", "1.25"
//        "TAP_CHANGER_EXISTENCE", "disabled", "TAP_CHANGER_INSTALLATION_WINDING", "onFirstWinding", "TAP_CHANGER_DEFAULT_POSITION", "0", "TAP_CHANGER_VOLTAGE_CHANGE", "1.78", "TAP_CHANGER_MAX_POSITION", "9", "TAP_CHANGER_MIN_POSITION", "-9"
